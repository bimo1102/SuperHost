            ...
            <div className="card">
                ...
                <div className="card-body flex flex-col gap-7.5 divide-y divide-gray-200">
                    <div className="grid gap-7 pt-7.5">
                        <div className="text-md font-semibold text-gray-900">1. Select SSO integration Type</div>
              ...
              `}
                    ...
                    <div className="grid gap-7 pt-7.5">
                        <div className="text-md font-semibold text-gray-900">2. Configure Google authentication</div>
                    ...
                    <div className="form-info pt-7.5 pb-5 text-gray-800 font-normal">
                        Single Sign-On (SSO) authentication streamlines access across multiple platforms. Users log in
                        once, gaining seamless entry <br />
