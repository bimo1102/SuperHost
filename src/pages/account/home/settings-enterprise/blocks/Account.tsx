                ...
                <table className="table align-middle text-sm text-gray-500">
                    <tbody>
                        <tr>
                            ...
                            <td className="text-gray-700 text-2sm font-normal min-w-32">150x150px JPEG, PNG Image</td>
                        ...
                        <tr>
                            ...
                            <td className="text-gray-700 text-2sm font-normal">Password last changed 2 months ago</td>
                            <td className="text-center">
                                <a href="#" className="btn btn-sm btn-icon btn-clear btn-primary">
                                    <KeenIcon icon="notepad-edit" />
                                </a>
