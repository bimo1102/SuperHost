    ...
    return (
        <div className="card">
            <div className="card-body lg:py-9">
                ...
                <div className="text-lg font-medium text-gray-900 text-center">Upload Item to Get Started</div>
                <div className="flex items-center justify-center gap-1">
                    <span className="text-sm text-gray-700">Begin by crafting your inaugural list in minutes.</span>
