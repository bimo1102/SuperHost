        ...
        <div className="card">
            ...
            <div className="grid gap-5 mb-5 px-7.5">
                <p className="text-sm text-gray-800 leading-5.5">
                    ...
                    how to write a great blog post in five simple steps that people will actually want to read. Ready?
                    Let’s get started.
                </p>
                ...
                <div className="grid grid-cols-2 gap-2.5 xl:gap-7.5">
                    <div>
                        <div
                            ...
                            style={{ backgroundImage: `url(${toAbsoluteUrl(`/media/images/600x600//21.jpg`)})` }}></div>
                    </div>
