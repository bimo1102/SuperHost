    ...
    return (
        <div className="card shadow-none border-0 mb-5">
            <div
                ...
                style={{ backgroundImage: `url(${toAbsoluteUrl(`/media/images/600x600/${image}`)})` }}></div>
            ...
            <div className="card-border card-rounded-b px-3.5 pt-5 pb-3.5">
                ...
                <div className="grid grid-cols-2 items-center">
                    ...
                    <div className="flex flex-col justify-self-end text-end gap-2">
                        ...
                        <span className="text-2sm font-semibold text-gray-900 leading-none tracking-tight">{date}</span>
                    </div>
                </div>
            </div>
        </div>
