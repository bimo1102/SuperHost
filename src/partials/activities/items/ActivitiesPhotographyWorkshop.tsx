    ...
    return (
        <TimelinesWrapper icon="code" line={true}>
            <div className="flex flex-col pb-2.5">
                <span className="text-sm text-gray-800">Jenny attended a Nature Photography Immersion workshop</span>
                        ...
                        <div className="flex flex-col md:flex-row md:items-center gap-5">
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <p className="text-xs text-gray-800 leading-[22px]">
                                    Enhance your nature photography skills in a hands-on workshop guided by experienced
                                    photographers.
                                </p>
                            </div>
                        </div>
